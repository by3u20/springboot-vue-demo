...
//        System.out.println(OpenCompartment);
        ...
        if( PickStatus.equals("Yes") && OpenStatus.equals("Yes")){
            if (dayOfWeek.equals(OpenCompartment)){
                if((dateTime.after(leftMorning) && dateTime.before(rightMorning)) ||
                    ...
                    GlobalStatus = "Normal";
                    eventLog = "Pick up the pillbox and open the compartment in the right medication time";
                }else{
                    GlobalStatus = "Abnormal";
                    eventLog = "Pick up the pillbox and open the compartment in the wrong medication time";
                }
            }else {
                GlobalStatus = "Abnormal";
        ...
        if( PickStatus.equals("Yes") && OpenStatus.equals("No")){
            if((dateTime.after(leftMorning) && dateTime.before(rightMorning)) ||
                    ...
                    (dateTime.after(leftEvening) && dateTime.before(rightEvening))){
                GlobalStatus = "Normal";
                eventLog = "Pick up the pillbox in the right medication time";
            }else{
                GlobalStatus = "Abnormal";
                eventLog = "Pick up the pillbox in the wrong medication time";
            }
        }
        ...
        if( PickStatus.equals("No") && OpenStatus.equals("Yes")){
            if (dayOfWeek.equals(OpenCompartment)){
                if((dateTime.after(leftMorning) && dateTime.before(rightMorning)) ||
                        ...
                        (dateTime.after(leftEvening) && dateTime.before(rightEvening))){
                    GlobalStatus = "Normal";
                    eventLog = "Open the compartment in the right medication time";
                }else{
                    GlobalStatus = "Abnormal";
                    eventLog = "Open the compartment in the wrong medication time";
                }
            }else {
                GlobalStatus = "Abnormal";
                eventLog = "Open incorrect compartment";
